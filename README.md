...
Project makes use of a simple LAMP stack, which was deployed on an Azure virtual machine for submission of the project however it is fairly straightforward to run locally.
